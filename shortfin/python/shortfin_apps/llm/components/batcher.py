...
from ...utils import BatcherProcessBase

from .kvcache.base_attention_cache import BasePagedAttentionCache
from .kvcache.base_attention_cache import CacheAllocationFailure
from .messages import LlmInferenceExecRequest
from .messages import InferencePhase
...
class LlmBatcherProcess(BatcherProcessBase):
    ...
    def __init__(self,
        ...
        self.prefill_functions = prefill_functions
        self.decode_functions = decode_functions
        ...
        self.ideal_batch_size: int = max(model_params.prefill_batch_sizes)
        self.page_seq_stride = model_params.paged_kv_cache.block_seq_stride
...
class InferenceExecutorProcess(sf.Process):
    ...
    async def run(self):
        try:
            ...
            if is_decode:
                entrypoints = self.decode_functions
            else:
                entrypoints = self.prefill_functions
